...
namespace Linq
{
    ...
    public static class AggregationOperations
    {
        ...
        public static IEnumerable<(string category, int totalUnitsInStock)> TotalUnitsInStock()
        {
            ...
            return products
                      .GroupBy(p => p.Category)
                      .Select(group => (category: group.Key, totalUnitsInStock: group.Sum(p => p.UnitsInStock)));
        }
        ...
        public static IEnumerable<(string category, decimal cheapestPrice)> GetCheapestPrice()
        {
            ...
            return products
                .GroupBy(p => p.Category)
                .Select(group => (category: group.Key, cheapestPrice: group.Min(cheap => cheap.UnitPrice)));
        }
        ...
        public static IEnumerable<(string category, decimal mostExpensivePrice)> GetMostExpensivePrice()
        {
            ...
            return products
               .GroupBy(p => p.Category)
               .Select(group => (category: group.Key, mostExpensivePrice: group.Max(expensive => expensive.UnitPrice)));
        }
        ...
        public static IEnumerable<(string Category, decimal averagePrice)> AveragePrice()
        {
            ...
            return products
               .GroupBy(p => p.Category)
               .Select(group => (category: group.Key, averagePrice: group.Average(avarage => avarage.UnitPrice)));
        }
        ...
        public static double Aggregate()
        {
            ...
            return doubles.Aggregate((total, number) => total * number);
        }
