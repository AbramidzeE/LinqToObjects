    ...
    public static class JoinOperations
    {
        ...
        public static IEnumerable<(string category, string productName)> LeftOuterJoin()
        {
            ...
            var query = from category in categories
                        ...
                        on category equals product.Category into productGroup
                        from prod in productGroup.DefaultIfEmpty()
                        select (category, productName: prod?.ProductName ?? "(No products)");
