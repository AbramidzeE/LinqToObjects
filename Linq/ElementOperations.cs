...
namespace Linq
{
    ...
    public static class ElementOperations
    {
        ...
        public static Product FirstElement()
        {
            ...
            return products.First(x=>x.ProductId == 11);
        ...
        public static string FirstMatchingElement()
        {
            ...
            return strings.FirstOrDefault(str => str.StartsWith("o"));
        ...
        public static string SingleMoreThanOneMatchingElement()
        {
            ...
            var find = strings.Single(str => str.Contains("o"));
            if (find == null)
            {
        ...
        {
            string[] strings = { "zero", "one", "two", "three", "four", "five", "six", "seven", "eight", "nine" };
            var find = strings.Where(str => str.Contains("o")).ToList();
            if (find.Count != 1)
            {
                return null;
            }
